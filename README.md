...
- Built a LangGraph-based document triage agent that classified project documents, extracted schedule/cost/safety risks, and routed issues to the right owner through a multi-step stateful workflow.
- Designed deterministic graph nodes for classification, issue extraction, urgency scoring, and action generation, producing structured outputs that were easy to test, audit, and extend.
- Created a GitHub-ready agent demo with sample inputs, typed state, and CI-friendly tests to showcase applied agent orchestration for forward-deployed / solutions-style engineering roles.

## Suggested GitHub repo name

- `agentgrid-demo`
- `langgraph-doc-triage`
- `construction-doc-agent`

`agentgrid-demo` is broadest and easiest to reuse across roles.
